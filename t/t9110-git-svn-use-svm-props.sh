...
test_expect_success 'verify metadata for /bar' "
	git cat-file cummit refs/remotes/bar >actual &&
	grep '^git-svn-id: $bar_url@12 $uuid$' actual &&
	git cat-file cummit refs/remotes/bar~1 >actual &&
	grep '^git-svn-id: $bar_url@11 $uuid$' actual &&
	git cat-file cummit refs/remotes/bar~2 >actual &&
	grep '^git-svn-id: $bar_url@10 $uuid$' actual &&
	git cat-file cummit refs/remotes/bar~3 >actual &&
	grep '^git-svn-id: $bar_url@9 $uuid$' actual &&
	git cat-file cummit refs/remotes/bar~4 >actual &&
	grep '^git-svn-id: $bar_url@6 $uuid$' actual &&
	git cat-file cummit refs/remotes/bar~5 >actual &&
	grep '^git-svn-id: $bar_url@1 $uuid$' actual
	"

e_url=http://mayonaise/svnrepo/dir/a/b/c/d/e
test_expect_success 'verify metadata for /dir/a/b/c/d/e' "
	git cat-file cummit refs/remotes/e >actual &&
	grep '^git-svn-id: $e_url@1 $uuid$' actual
	"

dir_url=http://mayonaise/svnrepo/dir
test_expect_success 'verify metadata for /dir' "
	git cat-file cummit refs/remotes/dir >actual &&
	grep '^git-svn-id: $dir_url@2 $uuid$' actual &&
	git cat-file cummit refs/remotes/dir~1 >actual &&
