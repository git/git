...
on_cummitter_date "00:03" save_tag l2 unique_cummit l2 tree -p l1
on_cummitter_date "00:04" save_tag a0 unique_cummit a0 tree -p l2
on_cummitter_date "00:05" save_tag a1 unique_cummit a1 tree -p a0
on_cummitter_date "00:06" save_tag b1 unique_cummit b1 tree -p a0
on_cummitter_date "00:07" save_tag c1 unique_cummit c1 tree -p b1
on_cummitter_date "00:08" save_tag b2 unique_cummit b2 tree -p b1
on_cummitter_date "00:09" save_tag b3 unique_cummit b2 tree -p b2
on_cummitter_date "00:10" save_tag c2 unique_cummit c2 tree -p c1 -p b2
on_cummitter_date "00:11" save_tag c3 unique_cummit c3 tree -p c2
on_cummitter_date "00:12" save_tag a2 unique_cummit a2 tree -p a1
on_cummitter_date "00:13" save_tag a3 unique_cummit a3 tree -p a2
on_cummitter_date "00:14" save_tag b4 unique_cummit b4 tree -p b3 -p a3
on_cummitter_date "00:15" save_tag a4 unique_cummit a4 tree -p a3 -p b4 -p c3
...
on_cummitter_date "00:00" hide_error save_tag F unique_cummit F tree
on_cummitter_date "00:01" save_tag e8 unique_cummit e8 tree -p F
on_cummitter_date "00:02" save_tag e7 unique_cummit e7 tree -p e8
on_cummitter_date "00:03" save_tag e6 unique_cummit e6 tree -p e7
on_cummitter_date "00:04" save_tag e5 unique_cummit e5 tree -p e6
on_cummitter_date "00:05" save_tag f4 unique_cummit f4 tree -p F
on_cummitter_date "00:06" save_tag f3 unique_cummit f3 tree -p f4
on_cummitter_date "00:07" save_tag f2 unique_cummit f2 tree -p f3
on_cummitter_date "00:08" save_tag f1 unique_cummit f1 tree -p f2
on_cummitter_date "00:09" save_tag e4 unique_cummit e4 tree -p e5
on_cummitter_date "00:10" save_tag e3 unique_cummit e3 tree -p e4
on_cummitter_date "00:11" save_tag e2 unique_cummit e2 tree -p e3
on_cummitter_date "00:12" save_tag e1 unique_cummit e1 tree -p e2
on_cummitter_date "00:13" save_tag E unique_cummit E tree -p e1 -p f1

on_cummitter_date "00:00" hide_error save_tag U unique_cummit U tree
on_cummitter_date "00:01" save_tag u0 unique_cummit u0 tree -p U
on_cummitter_date "00:01" save_tag u1 unique_cummit u1 tree -p u0
on_cummitter_date "00:02" save_tag u2 unique_cummit u2 tree -p u0
on_cummitter_date "00:03" save_tag u3 unique_cummit u3 tree -p u0
on_cummitter_date "00:04" save_tag u4 unique_cummit u4 tree -p u0
on_cummitter_date "00:05" save_tag u5 unique_cummit u5 tree -p u0
on_cummitter_date "00:06" save_tag V unique_cummit V tree -p u1 -p u2 -p u3 -p u4 -p u5
