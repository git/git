...
#      cummit, and pushes the result. It does this N times
...
#    which is updated in each cummit.
#
#    When generating push number X, we feed cummit X-1 (and
...
#
#      b. Eventually we move onto cummit X-1. We need other
