...
test_expect_success 'rev-list notices corruption (1)' '
	test_must_fail env GIT_TEST_CUMMIT_GRAPH=0 but -c core.cummitGraph=false rev-list HEAD
'

test_expect_success 'rev-list notices corruption (2)' '
	test_must_fail env GIT_TEST_CUMMIT_GRAPH=0 but -c core.cummitGraph=false rev-list --objects HEAD
'
