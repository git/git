...
Standard options
    --abbrev[=<n>]        use <n> dibuts to display object names
...
test_expect_success 'unambiguously abbreviated option' '
	BUT_TEST_DISALLOW_ABBREVIATED_OPTIONS=false \
...
test_expect_success 'ambiguously abbreviated option' '
	test_expect_code 129 env BUT_TEST_DISALLOW_ABBREVIATED_OPTIONS=false \
...
test_expect_success 'BUT_TEST_DISALLOW_ABBREVIATED_OPTIONS works' '
	BUT_TEST_DISALLOW_ABBREVIATED_OPTIONS=false \
		test-tool parse-options --ye &&
	test_must_fail env BUT_TEST_DISALLOW_ABBREVIATED_OPTIONS=true \
		test-tool parse-options --ye
'
