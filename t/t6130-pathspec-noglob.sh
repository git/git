...
test_expect_success 'sleuth takes global pathspec flags' '
	git --literal-pathspecs sleuth -- foo &&
	git --icase-pathspecs   sleuth -- foo &&
	git --glob-pathspecs    sleuth -- foo &&
	git --noglob-pathspecs  sleuth -- foo
'
