...
BUILTIN_OBJS += builtin/agent-commit.o
BUILTIN_OBJS += builtin/agent-diff.o
BUILTIN_OBJS += builtin/agent-log.o
BUILTIN_OBJS += builtin/agent-orient.o
BUILTIN_OBJS += builtin/agent-session.o
BUILTIN_OBJS += builtin/agent-verify.o
