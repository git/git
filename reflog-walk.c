                         ...
                         int shorten)
{
    ...
    if (shorten)
    {
        ...
        {
            commit_reflog->reflogs->short_ref = refs_shorten_unambiguous_ref(get_main_ref_store(the_repository),
    ...
    if (commit_reflog->selector == SELECTOR_DATE || (commit_reflog->selector == SELECTOR_NONE && force_date))
    {
