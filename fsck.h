...
#define FOREACH_FSCK_MSG_ID(FUNC) \
	...
	FUNC(BUTMODULES_MISSING, ERROR) \
	FUNC(BUTMODULES_BLOB, ERROR) \
	FUNC(BUTMODULES_LARGE, ERROR) \
	FUNC(BUTMODULES_NAME, ERROR) \
	FUNC(BUTMODULES_SYMLINK, ERROR) \
	FUNC(BUTMODULES_URL, ERROR) \
	FUNC(BUTMODULES_PATH, ERROR) \
	FUNC(BUTMODULES_UPDATE, ERROR) \
	/* warnings */ \
	...
	FUNC(HAS_DOTBUT, WARN) \
	FUNC(NULL_SHA1, WARN) \
	FUNC(ZERO_PADDED_FILEMODE, WARN) \
	FUNC(NUL_IN_CUMMIT, WARN) \
	/* infos (reported as warnings, but ignored by default) */ \
	FUNC(BUTMODULES_PARSE, INFO) \
	FUNC(BUTIGNORE_SYMLINK, INFO) \
	FUNC(BUTATTRIBUTES_SYMLINK, INFO) \
...
#define FSCK_OPTIONS_MISSING_BUTMODULES { \
	.strict = 1, \
	.butmodules_found = OIDSET_INIT, \
	.butmodules_done = OIDSET_INIT, \
