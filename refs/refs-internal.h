...
/*
 * Initialize the ref_store for the specified butdir. These functions
...
struct ref_store {
	...
	/*
	 * The butdir that this ref_store applies to. Note that this is not
	 * necessarily repo->butdir if the repo has multiple worktrees.
	 */
	char *butdir;
};
