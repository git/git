...
#define DIFF_PICKAXE_KINDS_G_REGEX_MASK     (DIFF_PICKAXE_KIND_G | DIFF_PICKAXE_REGEX)
#define DIFF_PICKAXE_KINDS_ALL_OBJFIND_MASK (DIFF_PICKAXE_ALL | DIFF_PICKAXE_KIND_OBJFIND)
