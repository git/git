...
`branch.sort`::
	...
	value of this variable will be used as the default. In Git 2.x this
	defaults to `refname`, sorting branches alphabetically. Starting with
	Git 3.0 this defaults to `-committerdate`, listing the most recently
