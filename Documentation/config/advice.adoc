...
--
	...
	largeFileAdded::
		Shown when linkgit:git-add[1] attempts to add a file
		larger than 50MB to the index. Suggests using Git LFS
		for large binary files or adding the file to .gitignore.
	mergeConflict::
