...
#define BUT_PCRE2_VERSION_10_36_OR_HIGHER
#endif
#if (PCRE2_MAJOR >= 10 && PCRE2_MINOR >= 34) || PCRE2_MAJOR >= 11
#define BUT_PCRE2_VERSION_10_34_OR_HIGHER
#endif
#else
...
#define GREP_OPT_INIT { \
	...
	.colors = { \
		[GREP_COLOR_CONTEXT] = "", \
		[GREP_COLOR_FILENAME] = BUT_COLOR_MAGENTA, \
		[GREP_COLOR_FUNCTION] = "", \
		[GREP_COLOR_LINENO] = BUT_COLOR_GREEN, \
		[GREP_COLOR_COLUMNNO] = BUT_COLOR_GREEN, \
		[GREP_COLOR_MATCH_CONTEXT] = BUT_COLOR_BOLD_RED, \
		[GREP_COLOR_MATCH_SELECTED] = BUT_COLOR_BOLD_RED, \
		[GREP_COLOR_SELECTED] = "", \
		[GREP_COLOR_SEP] = BUT_COLOR_CYAN, \
	}, \
	.only_matching = 0, \
	.color = -1, \
	.output = std_output, \
