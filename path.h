 ...
 */
__attribute__((format(printf, 1, 2))) static inline const char *git_common_path(const char *fmt, ...)
{
 ...
 * be overridden.
 */
__attribute__((format(printf, 2, 3))) static inline char *git_path_buf(struct strbuf *buf, const char *fmt, ...)
{
    va_list args;
    strbuf_reset(buf);
    va_start(args, fmt);
 ...
 */
__attribute__((format(printf, 2, 3))) static inline void strbuf_git_path(struct strbuf *sb, const char *fmt, ...)
{
    va_list args;
    va_start(args, fmt);
 ...
 */
__attribute__((format(printf, 1, 2))) static inline const char *git_path(const char *fmt, ...)
{
    struct strbuf *pathname = get_pathname();
    va_list        args;
    va_start(args, fmt);
 ...
 */
__attribute__((format(printf, 1, 2))) static inline char *git_pathdup(const char *fmt, ...)
{
