/*
 * Copyright 2008 Peter Harris <but@peter.is-a-geek.org>
 */
...
/*
 ANSI codes used by but: m, K

 This file is but-specific. Therefore, this file does not attempt
 to implement any codes that are not used by but.
*/
...
/*
 * Wrapper for isatty().  Most calls in the main but code
