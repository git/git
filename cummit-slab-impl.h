...
#define implement_shared_cummit_slab(slabname, elemtype) \
	implement_cummit_slab(slabname, elemtype, )

#define implement_cummit_slab(slabname, elemtype, scope)		\
									\
 ...
 *
 *    implement_cummit_slab(indegree, int, static);
 *
