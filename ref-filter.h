...
#define FILTER_REFS_REGULAR       (FILTER_REFS_TAGS | FILTER_REFS_BRANCHES | FILTER_REFS_REMOTES | FILTER_REFS_OTHERS)
#define FILTER_REFS_DETACHED_HEAD 0x0020
#define FILTER_REFS_PSEUDOREFS    0x0040
#define FILTER_REFS_ROOT_REFS     0x0080
#define FILTER_REFS_KIND_MASK     (FILTER_REFS_REGULAR | FILTER_REFS_DETACHED_HEAD | FILTER_REFS_PSEUDOREFS | FILTER_REFS_ROOT_REFS)
